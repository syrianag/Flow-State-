...
import { Users, Eye, Edit3, Plus } from "lucide-react";
      ...
      <div className="container py-12">
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 style={{ color: "var(--color-charcoal)" }} className="text-xl font-bold">
                Student Rubric
              </h1>
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="p-6 border-b border-gray-200">
            <h3 style={{ color: "var(--color-charcoal)" }} className="text-lg font-semibold">
              Student Overview
            </h3>
          </div>
            ...
            <table className="w-full">
              ...
              <tbody>
                {students.map((student) => (
                  <tr
                    key={student.id}
                    className={`border-t ${getRiskBorder(student.burnoutRisk)} hover:bg-gray-50`}
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-3 py-1 rounded-full text-xs ${getRiskColor(student.burnoutRisk)}`}
        ...
        <div className="mt-8 bg-white rounded-xl shadow-sm p-6">
          <h3 className="mb-6 text-lg font-semibold" style={{ color: "var(--color-charcoal)" }}>
            Productivity Rubric Template
          </h3>

          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-teal-50 rounded p-3">
              <p style={{ fontWeight: 600, color: "var(--color-teal)" }} className="mb-1">
                Excellent (90-100%)
              </p>
            ...
            <div className="bg-orange-50 rounded p-3">
              <p style={{ fontWeight: 600, color: "var(--color-sage)" }} className="mb-1">
                Good (70-89%)
              </p>
